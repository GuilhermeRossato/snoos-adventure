...
const server = http.createServer((req, res) => {
    ...
    return execSafe(
      () =>
        res.writeHead(200, {
          ...
          'Date': new Date().toUTCString(),
          'Last-Modified': fs.statSync("./favicon/favicon.ico").mtime.toUTCString(),
  ...
  const url = req.url.startsWith('/personal-fs/file/data/human/') ? req.url.replace('/personal-fs/file/data/human/', '/') : req.url;
